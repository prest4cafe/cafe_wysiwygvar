 ...
 <div class="product col-xs-6 col-xl-4">
   <article class="product-miniature" data-id-product="{$product.id_product}" data-id-product-attribute="{$product.id_product_attribute}">
     <div class="thumbnail-container">
       ...
       <div style="min-height: 110px;" class="product-description">
         {block name='product_name'}
          <span style="    font-size: 22px;
          color: #000;
          text-align: center;
          text-decoration: none;
          font-family: 'OPTIPermanentHeadline';
          text-transform: uppercase;
          font-weight: normal;
          line-height: 26px;
          word-wrap: break-word;" class="product_brand">{Manufacturer::getnamebyid($product.id_manufacturer)}</span>
